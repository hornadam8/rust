...
impl Hand {
    ...
    pub fn inline_print(&self) -> String {
        let mut message = String::new();
        for card in self.cards.iter() {
            let mut value_str = String::new();
            value_str.push_str(card.value.string_val().as_str());
            if card.value == Value::Ten {
                value_str.push_str(" ");
            }
            message.push_str(format!("{}{}", card.suit.string_val(), value_str).as_str());
        }
        message
    }

    pub fn card_string(&self) -> String {
        let mut line_1 = String::from("\n");
        let mut line_2 = String::new();
        let mut line_3 = String::new();
        let mut line_4 = String::new();
        let mut line_5 = String::new();
        let mut line_6 = String::new();
        let mut line_7 = String::new();
        let mut line_8 = String::new();
        let mut line_9 = String::new();
        for card in self.cards.iter() {
            line_1.push_str("┌─────────┐ ");
            line_2.push_str(format!("│{}       │ ", card.value.string_val()).as_str());
            line_3.push_str("│         │ ");
            line_4.push_str("│         │ ");
            line_5.push_str(format!("│    {}    │ ", card.suit.string_val()).as_str());
            line_6.push_str("│         │ ");
            line_7.push_str("│         │ ");
            line_8.push_str(format!("│       {}│ ", card.value.string_val()).as_str());
            line_9.push_str("└─────────┘ ");
        }
        format!(
            "{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n",
    ...
    pub fn dealer_card_string(&self) -> String {
        ...
        let mut line_9 = String::new();
        line_1.push_str("┌─────────┐ ");
        line_2.push_str(format!("│{}       │ ", self.cards[0].value.string_val()).as_str());
        line_3.push_str("│         │ ");
        line_4.push_str("│         │ ");
        line_5.push_str(format!("│    {}    │ ", self.cards[0].suit.string_val()).as_str());
        line_6.push_str("│         │ ");
        line_7.push_str("│         │ ");
        line_8.push_str(format!("│       {}│ ", self.cards[0].value.string_val()).as_str());
        line_9.push_str("└─────────┘ ");

        line_1.push_str("┌─────────┐ ");
        line_2.push_str("│*********│ ");
        line_3.push_str("│VVVVVVVVV│ ");
        line_4.push_str("│VVVVVVVVV│ ");
        line_5.push_str("│*********│ ");
        line_6.push_str("│VVVVVVVVV│ ");
        line_7.push_str("│VVVVVVVVV│ ");
        line_8.push_str("│*********│ ");
        line_9.push_str("└─────────┘ ");
        format!(
            "   Dealer showing:\n\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n",
